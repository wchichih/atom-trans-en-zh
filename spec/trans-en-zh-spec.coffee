TransEnZh = require '../lib/trans-en-zh'
...
describe "TransEnZh", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('trans-en-zh')

  describe "when the trans-en-zh:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      # Before the activation event the view is not on the DOM, and no panel
      # has been created
      expect(workspaceElement.querySelector('.trans-en-zh')).not.toExist()
      ...
      runs ->
        expect(workspaceElement.querySelector('.trans-en-zh')).toExist()
